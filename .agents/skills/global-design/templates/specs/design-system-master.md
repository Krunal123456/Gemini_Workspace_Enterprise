...
**Do not** restate the full token system from scratch — start from `SKILL.md` Design Tokens (Core) or `tokens/tokens.css` and record the project's *deltas* and *choices*.
...
*Template version: global-design-skill v2.7.0*
*Related: `rules/00-escalation-protocol.md` (Dials, Macrostructure, Memorability Gate), `SKILL.md` (Design Tokens Core), `tokens/tokens.css`, `templates/briefs/project-brief.md` (the what/why this freezes the how for), `blueprints/website-from-scratch.md` (Step 0)*
