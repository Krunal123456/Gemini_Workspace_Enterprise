...
*Reference version: global-design-skill v2.7.0*
*Related: `rules/05-animation.md` (timing, personality, amplitude limits), `rules/17-motion-react.md` (motion/react — the default for React) (CSS-native motion, easing and duration tokens), `patterns/effects/scroll-experiences.md` and `patterns/effects/parallax-system.md` (built scroll patterns)*
