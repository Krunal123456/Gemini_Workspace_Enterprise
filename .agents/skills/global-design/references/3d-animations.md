...
*Related: `references/motion-systems.md`, `references/motion-dev.md`, `references/gsap-patterns.md` (scroll-driving a 3D scene), `patterns/effects/3d-effects.md` (copy-ready code)*
