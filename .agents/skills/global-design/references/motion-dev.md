...
> `motion/react` hooks, scroll-triggered animations, AnimatePresence, layout animations, and GSAP integration for React 19 + Next.js 16. For CSS-native animation patterns, see .
...
*Related: `rules/05-animation.md`, `SKILL.md` §GSAP*
