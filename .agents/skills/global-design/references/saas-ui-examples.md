...
> Annotated examples of SaaS product UI patterns worth studying. Each entry explains what specifically to learn, not just who to look at. Used by the `reference-hunter` agent for Capability 1 (block category search) and Capability 3 (competitive analysis).
...
*Reference version: global-design-skill v1.0*  
*Updated: 2026-05-20*  
*Related: `patterns/product-ui/`*
