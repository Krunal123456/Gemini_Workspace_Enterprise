...
>
> **For trendy named looks** (glassmorphism, aurora/mesh, OLED-luxury, brutalism) — how to compose them from existing techniques with accessibility guardrails — see .
...
*Updated: 2026-05-20*  
*Related: `references/inspiration-sites.md`, `SKILL.md`*
