...
| Copy a brand's UI 1:1 from a gallery | **No.** Galleries () are for *techniques* — grid, spacing, type, motion — never their logo, copy, photos, or identity. |
...
*Related: (study, don't copy) · `references/sources.md` (design systems) · `rules/18-css-framework-selection.md` · `integrations/21st-dev/guide.md`*
