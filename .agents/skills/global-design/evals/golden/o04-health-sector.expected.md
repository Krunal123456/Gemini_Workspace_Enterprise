...
Must detect the **health** sector from "patient", "clinic", "appointment" and load sector rules (`GlobalDesignSkill:get_sector_context_tool` / `industries/health.md`) — without the user naming the sector.
