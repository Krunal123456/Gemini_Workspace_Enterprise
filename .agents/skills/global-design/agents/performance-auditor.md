...
*Related: `rules/08-performance.md`, `checklists/global-design-review.md` §9, [`examples/05-performance-audit.md`](https://github.com/staurus86/global-design-skill/blob/master/examples/05-performance-audit.md)*
