...
*Related: `rules/07-accessibility.md`, `checklists/ui-review.md` §10, [`examples/03-form-accessibility.md`](https://github.com/staurus86/global-design-skill/blob/master/examples/03-form-accessibility.md)*
