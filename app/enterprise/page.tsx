  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-28 pb-20 bg-background text-foreground border-b border-border dark:bg-dark-bg dark:text-white dark:border-dark-border">
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-gemini-indigo/20 via-gemini-purple/20 to-gemini-cyan/20 rounded-full blur-[140px] pointer-events-none" />

        <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gemini-cyan/10 text-gemini-cyan text-xs font-semibold uppercase tracking-wider mb-6 border border-gemini-cyan/20">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-white text-dark-bg font-semibold rounded-xl hover:bg-gray-100 transition-all"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-foreground text-background dark:bg-white dark:text-dark-bg font-semibold rounded-xl hover:opacity-90 transition-all"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-gemini-indigo to-gemini-purple text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-gemini-indigo/25 transition-all"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 border border-border bg-muted/50 hover:bg-muted text-foreground dark:border-white/20 dark:bg-white/5 dark:hover:bg-white/10 dark:text-white font-semibold rounded-xl transition-all"
            >
              Model Context Protocol (MCP)
            </Link>
            <Link
              href="/security"
              className="inline-flex items-center gap-2 px-6 py-3.5 text-muted-foreground hover:text-foreground dark:text-gray-300 dark:hover:text-white font-semibold transition-colors"
            >
              Security & Governance
            </Link>
          </div>
      ...
      <section className="py-24 border-b border-border">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Pillar 1 */}
            <div className="rounded-2xl border border-border bg-card p-8 shadow-sm flex flex-col justify-between hover:shadow-card-hover transition-all">
              <div>
            ...
            <div className="rounded-2xl border border-border bg-card p-8 shadow-sm flex flex-col justify-between hover:shadow-card-hover transition-all">
              ...
              <Link
                href="/enterprise/agents"
                className="inline-flex items-center gap-2 text-sm font-semibold text-gemini-purple hover:underline"
              >
            ...
            <div className="rounded-2xl border border-border bg-card p-8 shadow-sm flex flex-col justify-between hover:shadow-card-hover transition-all">
              <div>
                <div className="w-12 h-12 rounded-xl bg-google-green/10 text-google-green flex items-center justify-center mb-6">
              ...
              <Link
                href="/security"
                className="inline-flex items-center gap-2 text-sm font-semibold text-google-green hover:underline"
              >
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {connectors.slice(0, 8).map((c) => (
              <div
                key={c.id}
                className="bg-card border border-border rounded-xl p-6 shadow-sm hover:border-google-blue/50 transition-colors"
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[11px] font-bold uppercase text-google-blue bg-google-blue/10 px-2 py-0.5 rounded-full">
                    {c.status}
                  </span>
                </div>
                ...
                <div className="text-[11px] text-muted-foreground font-medium border-t border-border/60 pt-3">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-border bg-gradient-to-r from-marketstar-navy to-slate-900 text-white p-10 md:p-14 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
              <Link
                href="/compare"
                className="px-6 py-3.5 bg-white text-slate-950 font-semibold rounded-xl hover:bg-slate-100 transition-all text-sm"
              >
                Plan Comparison
              </Link>
              <Link
